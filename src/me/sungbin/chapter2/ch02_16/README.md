...
![static.png](https://gitlab.com/easyspubjava/javacoursework/-/raw/master/Chapter2/2-16/img/static.png)
...
- static 변수는 인스턴스에서 공통으로 사용하는 영역임음 알 수 있음
  ![mem](https://gitlab.com/easyspubjava/javacoursework/-/raw/master/Chapter2/2-16/img/mem.png)
